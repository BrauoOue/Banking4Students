...
const Explore = () => {
  ...
  const partnershipsCards = [
    ...
    },
    {
      ...
      title: "Netflix",
      img:
        "https://images.ctfassets.net/4cd45et68cgf/6wHlMkLFTfKk3cQrTYnVLL/bdbbd0da407283d0833aa4575b4e81dd/Netflix_LinkdinHeader_N_Texture_5.png?w=2560",
      date: "20.03.2025",
          ...
          >
            ...
            <View style={{ padding: 16 }}>
              ...
              <View style={{ alignItems: "flex-end" }}>
                <Text style={{ fontSize: 14, color: "#666" }}>
                  {card.points} <Image source={icons.coins} className="w-6 h-4" resizeMode="contain"/>
                  {/* ovde */}
                </Text>
              </View>
            </View>
            ...
            >
              ...
              {activeTab === "Partnerships" ? (
                <>
                  ...
                  <Text>-{selectedCard.points}
                    <Image source={icons.coins} className="w-6 h-4" resizeMode="contain"/>
                  </Text>
                  {!showQRCode ? (
                    <TouchableOpacity
                      onPress={handleClaim}
                ...
                <>
                  <Text>{selectedCard.duration}</Text>
                  <Text>{selectedCard.frequency}</Text>
                  <Text>{selectedCard.date}</Text>
                  <Text>-{selectedCard.points}
                  <Image source={icons.coins} className="w-6 h-4" resizeMode="contain"/> </Text> 
                  {/* ovde */}
